      ...
      <div className="max-w-5xl mx-auto">
        ...
        {tab === 'audio' && (
          <div className="bg-white rounded-2xl shadow-sm border border-stone-100 p-6 space-y-4">
            {mediasFiltres.map((item: MediaItem) => (
              <a key={item.id} href={item.url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-amber-50 rounded-lg hover:bg-amber-100 transition">
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 bg-red-900 rounded-full flex items-center justify-center text-white flex-shrink-0">
